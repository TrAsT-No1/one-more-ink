    ...
    <main>
      ...
      <nav className="tattoo-pattern fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-5 bg-ink/70 backdrop-blur-md">
        ...
        <div className="flex items-center gap-6">
          <Link href="/artisti" className="text-xs font-display uppercase tracking-widest text-paper">
            Artisti
          </Link>
      ...
      {/* Philosophy */}
      <section className="bg-ink text-paper px-6 py-16 md:py-24 relative overflow-hidden">
