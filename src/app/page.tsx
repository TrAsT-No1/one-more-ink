  ...
  return (
    <main>
      ...
      <section className="relative px-6 py-section-mobile md:py-section bg-ink text-paper">
        <div className="absolute inset-0 pointer-events-none z-0 mix-blend-screen" style={{ backgroundImage: 'url(/tattoo-pattern.png)', backgroundRepeat: 'repeat', backgroundSize: '500px 390px', opacity: 0.25 }} />
