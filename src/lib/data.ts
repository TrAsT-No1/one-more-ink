...
export const services: Service[] = [
  { id: "custom", name: "Tatuaggi Custom", description: "Ogni pezzo è unico. Partiamo dalla tua idea, la sviluppiamo insieme e creiamo qualcosa che ti rappresenta.", icon: "pen-tool", whatsappMessage: "Ciao! Mi piacerebbe fare un tatuaggio custom con voi.\n\nHo in mente un soggetto in stile [STILE - es. blackwork, traditional, fine line...], di dimensione circa [PICCOLO / MEDIO / GRANDE], nella zona [ZONA DEL CORPO].\n\nL'idea e': [DESCRIVI BREVEMENTE LA TUA IDEA]\n\nQuando potremmo fissare una consulenza per parlarne?" },
  { id: "coverup", name: "Cover Up", description: "Trasformiamo vecchi tatuaggi in nuove opere. Il primo incontro è sempre gratuito.", icon: "layers", whatsappMessage: "Ciao! Ho un tatuaggio che vorrei coprire o trasformare.\n\nSi trova nella zona [ZONA DEL CORPO], e' grande circa [DIMENSIONE in cm] e lo stile attuale e' [DESCRIVI - es. scritta, tribale, disegno...].\n\nVorrei trasformarlo in qualcosa di [DESCRIVI L'IDEA O LO STILE CHE TI PIACE].\n\nPosso mandarvi una foto e fissare una consulenza gratuita?" },
  { id: "piercing", name: "Piercing", description: "Piercing professionali con materiali certificati e assistenza completa post-piercing.", icon: "circle-dot", whatsappMessage: "Ciao! Sono interessato/a a fare un piercing.\n\nVorrei un [TIPO - es. lobo, helix, trago, setto, sopracciglio...] e volevo chiedervi info su disponibilita, materiali e prezzo.\n\nQuando potrei passare in studio?" },
  { id: "consulenza", name: "Consulenza Gratuita", description: "Vieni a trovarci, raccontaci la tua idea. Il primo incontro è offerto da noi.", icon: "message-circle", whatsappMessage: "Ciao! Vorrei prenotare una consulenza gratuita per parlare di un tatuaggio.\n\nHo un'idea ma non so ancora bene come realizzarla - mi piacerebbe confrontarmi con voi su stile, posizione e dimensione.\n\nQuando avete disponibilita per un incontro in studio?" },
]
